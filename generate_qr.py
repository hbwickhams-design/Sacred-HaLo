...
# QR Code URL
url = "https://sacredhaloconnection.com/care"
...
# Save simple QR code
qr_img.save("care/qr-code-simple.png")
print("✓ Simple QR code saved: care/qr-code-simple.png")

# Create branded version with text
...
canvas.save("care/qr-code-branded.png")
print("✓ Branded QR code saved: care/qr-code-branded.png")

print(f"\n✓ QR codes created successfully!")
print(f"  URL: {url}")
print(f"  Location: /home/user/webapp/care/")
